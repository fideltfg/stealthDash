...
router.post('/credentials', authMiddleware, async (req, res) => {
  ...
  const validServiceTypes = ['pihole', 'unifi', 'unifi_api', 'home_assistant', 'google_calendar', 'docker', 'snmp', 'modbus', 'api', 'vnc', 'sensi', 'glances', 'todoist', 'speedtest_tracker', 'custom'];
